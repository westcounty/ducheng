...
export const PHOTO_DIARY_PAIRS = [
  {
    ...
    diaryExcerpt:
      '湖面比我记忆中大得多。桥上很多人，他们在一座断了名字的桥上走来走去。我听到一个人说"断桥其实不断"。那它为什么叫断桥？人类的语言真的很麻烦。道具卡上列出了"断桥"名字的三种民间解释——找到石碑，看看哪种有实物依据。',
    annotation: '他们称之为选择'
  },
  {
    stage: 2,
    ...
    diaryExcerpt:
      '心里有一种说不出的东西。在山上遇到一块石头，上面刻着一首诗。写诗的人已经死了很久了。但他种的梅花还活着——不对，梅花也死了。但有人又种了新的。我也试着写了一首诗。写得很烂。但是我写得很认真。',
    annotation: '他们称之为陪伴'
  },
  {
    stage: 3,
    ...
    diaryExcerpt:
      '有一种植物的叶子，他们摘下来烤干泡在热水里喝。后来一个老人对我说："第一口是苦的，第二口是甜的。你要等。"我等了。第二口还是苦的。但我好像懂了一点点——他们享受的不是味道，是等待本身。他们管这叫"耐心"。',
    annotation: '他们称之为耐心'
  },
  {
    stage: 4,
    ...
    diaryExcerpt:
      '一件我完全无法理解的事。我问一个老人："他做了什么？"老人说："他精忠报国。"我说："然后呢？"老人说："然后他被冤枉死了。"这不合理。一个死了的人，怎么会比活着的人更重要？但是我站在那里看了很久，我竟然——眼睛里有水。这是第一次。',
    annotation: '他们称之为忠诚'
  },
  {
    stage: 5,
    ...
    diaryExcerpt:
      '人会死，这我知道。但让我吃惊的不是诗——是这条堤。诗可以不写，堤不能不修。西湖水淹进城里，人会淹死。他是来写诗的，最后去挖泥了。我忽然很想为一个人做一件没用的事。不是因为有用，是因为想做。',
    annotation: '他们称之为建造'
  },
  {
    stage: 6,
    ...
    diaryExcerpt:
      '未曾有过这种感觉。钟声响了，很大声，然后停了。但他们没有走——所有人都还站在那里。他们在听什么？钟已经不响了。后来我也听到了。钟声停了之后，空气里还有东西在振动。不是声音，是声音的影子。他们管这叫"回响"。',
    annotation: '他们称之为信仰'
  },
  {
    stage: 7,
    ...
    diary: '走不了了……',
    diaryExcerpt:
      '走不了了……（这一页几乎是空白的。只有三个字，然后是墨渍。像是笔尖停在纸上太久，墨水洇开了。纸的下半部分有几处水渍——不是雨水。更像是有什么东西从很近的地方滴下来的。）',
