...
关于他的朋友，旅记里只有零星描写：般若念经念到一半会睡着，阿史那是他见过最大的人但怕猫，约翰花三个小时跟般若争论完了一起喝酒，张怀远写个招牌要写三天，阿倍来长安时不到二十岁如今三十余年还没回去，伊本评价城市只看集市好不好，胡禄信火说火不灭就是神还在。
...
export const FINALE = {
   ...
   */
  envelopePrompt: '现在，打开那个信封。站在唐代城墙的上方，打开。',
...
export const HEYING_CHECKLIST = [
  ...
  { stage: 7, dish: '石榴汁', friend: '胡禄', note: '胡禄每次过含光门都被盘问最久，因为他的货物里总有火焰的气味。他说波斯人相信石榴是天堂的果实' }
]
...
export const STAGE_LOCATIONS = [
  ...
  { stage: 7, name: '含光门遗址博物馆', address: '西安市碑林区含光路，含光门内' }
]
...
export const PHOTO_DIARY_PAIRS = [
  ...
  },
  {
    ...
    diaryExcerpt:
      '下了鼓楼的台阶，阿倍仲麻吕站了很久没动。他来长安的时候不到二十岁，现在三十余年了还没回去。我问他想不想家，他念了一首和歌，我没听懂，但他哭了。他说长安的鼓声告诉他几点该回家，但他的家在海的那边，鼓声传不到。我不知道怎么安慰他。我给他倒了一杯酒。'
  },
  {
    stage: 6,
  ...
  {
    stage: 7,
    prompt: '拍下唐城墙断面——胡禄说\'这座城不需要神\'。三层土壤，三个朝代，一千三百年',
    diary: '胡禄说\'这座城不需要神\'。我想他的意思是：这座城自己就是神迹。',
    diaryExcerpt:
      '邦国之交，终归于一桌酒席。胡禄信火。他说火不灭就是神还在。我给他看过含光门外的万家灯火，他站了很久，说："这座城不需要神。"我问为什么。他说："因为这座城自己就在发光。"那天是上元节。城墙下面埋着唐代的门槛。一千三百年后有人挖开了看——门槛还在。胡禄说过，火不灭就是神还在。这座城的火，从唐烧到明，从没灭过。'
  }
]
